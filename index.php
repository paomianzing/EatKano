...
<head>
    <title>吃掉栗川凛</title>
    <meta itemprop="name" content="吃掉栗川凛" />
    <meta itemprop="description" content="BLIERS的日常" />
    <meta charset="utf-8" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">吃掉凛川凛</div><br />
                ...
                <div id="setting" style="display: none;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="title" class="form-control" placeholder="吃掉栗川凛">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
